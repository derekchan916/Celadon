...
(function() { this.JST || (this.JST = {}); this.JST["cartItems/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'checkout-message hidden group\' id=\'order-message\'>\n  <img class="checkmark" src="',  Celadon.checkmarkLogo ,'">\n  <span class=\'order-message-sentence\'>You have successfully placed an order!\n  </span>\n</div>\n\n<div class=\'checkout-bar\'>\n  <span class=\'quick-details\'>\n    Subtotal (',  Celadon.currentUser.escape('number_of_cart_items') ,' item(s)):\n    <span class="money">$',  Celadon.currentUser.escape('current_subtotal') ,'</span>\n  </span>\n  <span class=\'add-cart-message-btn sign-in-btn\'>\n    <button id="checkout-btn">Proceed to checkout</button>\n  </span>\n\n\n  <span class=\'order-details group\'>\n    <h4>Order Summary</h4>\n    <p class=\'checkout-left detail\'>Items:</p>\n    <p class=\'checkout-right detail\'>$',  Celadon.currentUser.escape('current_subtotal') ,'</p>\n    <p class=\'checkout-left detail\'>Shipping & handling:</p>\n    <p class=\'checkout-right detail\'>$0.00</p>\n    <p class=\'checkout-left detail\'>Taxes:</p>\n    <p class=\'checkout-right detail\'>Never</p>\n    <p class=\'checkout-left bold\'>Estimated order total:</p>\n    <p class=\'checkout-right bold money\'>$',  Celadon.currentUser.escape('current_subtotal') ,'</p>\n  </span>\n</div>\n\n<div class="cart-content">\n  <h3>Shopping Cart</h3>\n  <div class="price-quantity group">\n    <span class="quantity-column">\n      Quantity\n    </span>\n    <span class="price-column">\n      Price\n  </div>\n  <ul class="cart-items"></ul>\n</div>\n\n<div class="modal-checkout hidden">\n  <div class="modal-checkout-screen darken"></div>\n  <div class="confirmation-page">\n    <span class="confirmation-page-header">Are you sure you sure?</span>\n    <button class="place-order sign-in-btn" id=\'place-order-btn\'>Place Order</button>\n    <button class="cancel" id=\'cancel-confirmation\'>Cancel</button>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cartItems/list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'cart-product-img\'>\n  <img src="',  product.escape('image_url') ,'">\n</div>\n<div class=\'cart-product-content\'>\n  <div class=\'poke-content-header\'>\n    <h3>\n      <a href=\'#/product/',  product.escape('product_id') ,'\'>',  product.escape('name') ,'</a>\n      <span class="quantity-column">\n        ',  product.escape('quantity') ,'\n      </span>\n      <span class="price-column">\n        $',  product.escape('price') ,'\n      </span>\n    </h3>\n    <span>Added on: ',  product.escape('updated_at') ,'</span>\n    <p class="in-stock">In Stock.</p>\n    <p class="delete-cart-item" id=\'cart-product-delete\'>Delete</p>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<div class="navbar-ad">\n</div>\n<nav class="navbar group" role="navigation">\n\n  <div class="navbar-logo">\n    <a class="navbar-logo-img" href="#">\n      <img src="',  Celadon.logo ,'">\n    </a>\n  </div>\n\n  <div class="search-bar group">\n    <div class="search-bar-input group">\n      <input\n        class="search-bar-input-bar"\n        id="search-bar"\n        type="text"\n        name="user-input">\n      <div class="search-bar-button">\n        <img\n          class="search-bar-img"\n          src="',  Celadon.magnifyingGlass ,'">\n      </div>\n    </div>\n  </div>\n  <div class="navbar-btn-left">\n    <span class="span-button button0 button-able-hover" data="button0">\n      <span class="line1">Shop by</span>\n      <span class="line2">Category\n        <span class="arrow">\n          <div class="dropdown hidden">\n            <span class="dropdown-arrow type-dropdown"></span>\n              <ul>\n                ');  Celadon.types.each(function(type){ ; __p.push('\n                  <li class="tabs category-drop">\n                    <a href="#/products/',  type.escape('name') ,'">',  type.escape('name') ,'\n                      <span class="',  type.escape('name') ,' type-indicator navbar-type">\n                        ',  type.escape('name') ,'\n                      </span>\n                    </a>\n                  </li>\n                ');  }) ; __p.push('\n              </ul>\n          </div>\n        </span>\n      </span>\n    </span>\n  </div>\n  <span class="under-search-input-links">\n    ');  if (currentUser.isSignedIn()) { ; __p.push('\n      <a href="#/user/',  currentUser.id ,'">',  currentUser.escape('fname'),'\'s Celadon.com</a>\n    ');  } ; __p.push('\n    <a href="#/products">Search by filters</a>\n  </span>\n\n  <div class="navbar-btn-right">\n\n    ');  if (currentUser.isSignedIn()) { ; __p.push('\n      <span class="span-button button1 button-able-hover" data="button1" id=\'user-page-btn\'>\n    ');  } else { ; __p.push('\n      <span class="span-button button1 button-able-hover" data="button1" id=\'session-new-btn\'>\n    ');  } ; __p.push('\n      <span class="line1">Hello.\n        ');  if (currentUser.isSignedIn()) { ; __p.push('\n          ',  currentUser.escape('fname') ,'\n        ');  } else { ; __p.push('\n          Sign in\n        ');  } ; __p.push('\n      </span>\n      <span class="line2">Your Account\n        <span class="arrow">\n\n          <div class="dropdown hidden">\n            <span class="dropdown-arrow"></span>\n              <ul>\n                ');  if (!currentUser.isSignedIn()) { ; __p.push('\n                  <li class="dropdown-btn">\n                    <a class="dropdown-btn-link sign-in-btn" href="#/session/new">Sign in</a>\n                  </li>\n                  <li>New customer? <a class="start-here" href="#/users/new">Start here.</li>\n                ');  } ; __p.push('\n                <li><a href="#/user/',  currentUser.id ,'">Your Account</a></li>\n                <li><a href="#/user/',  currentUser.id ,'/ordered_items">Your Orders</a></li>\n                <li><a href=\'#\'>Your Wish List</a></li>\n                <li><a href=\'#\'>Your Recommendations</a></li>\n                ');  if (currentUser.isSignedIn()) { ; __p.push('\n                  <li><a id="sign-out-link">Not ',  currentUser.escape('fname') ,'? Sign out</a>\n                  </li>\n                ');  } ; __p.push('\n              </ul>\n          </div>\n        </span>\n      </span>\n    </span>\n\n    <span class="span-button button2 button-able-hover" data="button2">\n      <span class="line1">Wish</span>\n      <span class="line2">List\n        <span class="arrow">\n          <div class="dropdown hidden">\n            <span class="dropdown-arrow type-dropdown"></span>\n              <ul>\n                  <li><a href="#">Coming soon...</a></li>\n              </ul>\n          </div>\n        </span>\n      </span>\n    </span>\n\n    ');  if (currentUser.isSignedIn()) { ; __p.push('\n      <span class="span-button cart-button" id=\'to-cart-btn\'>\n        <span class="cart-img"><img src="',  Celadon.pokeball ,'"></span>\n      <span class="line11 cart-number">',  Celadon.currentUser.escape('number_of_cart_items') ,'</span>\n    ');  } else { ; __p.push('\n      <span class="span-button" id=\'to-cart-btn\'>\n        <span class="cart-img"><img src="',  Celadon.pokeball ,'"></span>\n      <span class="line11 cart-number">0</span>\n    ');  } ; __p.push('\n      <span class="line22 cart-cart">Cart</span>\n    </span>\n  </div>\n</nav>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["homePage/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="homepage-all-products group">\n  <div class="recommended-for-you group">\n    <h4></h4>\n    <div class="recommended-products group"></div>\n  </div>\n  <div class="most-viewed group">\n    <h4>Most Viewed Products</h4>\n    <div class="most-viewed-products group"></div>\n  </div>\n  <div class="all-view group">\n    <h4>\n      <a href="#/products">\n        All Available Products\n        <a class="see-more-tab" href="#/products">\n          See more...\n        </a>\n      </a>\n    </h4>\n    <div class="all-product-views group"></div>\n  </div>\n</div>\n\n<div class="advertisement7">\n  <a href="http://www.domio.xyz">\n    <img src="',  Celadon.domiologo ,'">\n  </a>\n  <a href="http://www.mumblrr.com">\n    <img src="',  Celadon.mumblrlogo ,'">\n  </a>\n  <a href="http://help-whats-for-lunch.herokuapp.com">\n    <img src="',  Celadon.helplogo ,'">\n  </a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["homePage/products_list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="homepage-image">\n  <a href="#/product/',  product.id ,'">\n    <img src="',  product.escape('image_url') ,'">\n  </a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["orderedItems/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3>Your Orders</h3>\n<ul class="ordered-items"></ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["orderedItems/list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'ordered-product-header group\'>\n  <div class=\'ordered-product-header-left\'>\n    ORDER # ',  product.escape('order_id') ,'\n  </div>\n</div>\n\n<div class=\'ordered-product-content group\'>\n  <div class=\'ordered-product-content-left\'>\n    <div class=\'ordered-date\'>\n      ORDER PLACED ',  product.escape('created_at') ,'\n    </div>\n    <div class=\'ordered-product-img\'>\n      <img src="',  product.escape('image_url') ,'">\n    </div>\n    <h4><a href="#/product/',  product.escape('product_id') ,'">',  product.escape('name') ,'</a></h4>\n    <div class=\'ordered-product-header-left\'>\n      <span class=\'money\'>$',  product.escape('price') ,'</span><br>\n      Quantity: ',  product.escape('quantity') ,'\n    </div>\n  </div>\n  <div class=\'ordered-product-content-right\'>\n    <a class=\'sign-in-btn\' href="#/product/',  product.escape('product_id') ,'">Buy it Again</a>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["products/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="advertisement5">\n  <h4>Expand your horizons</h4>\n  <form class="filter-list-categories">\n    <span class="form-header">Categories</span>\n    ');  Celadon.types.each(function(type){ ; __p.push('\n      <input class="checkbox-input"\n             type="checkbox"\n             name="category"\n             value="',  type.escape('name') ,'"\n             ');  if (categories) { ; __p.push('\n               ');  categories.forEach(function(category) { ; __p.push('\n                 ');  if (category === type.escape('name') ) { ; __p.push('\n                   ',  "checked" ,'\n                 ');  } ; __p.push('\n               ');  }) ; __p.push('\n             ');  } ; __p.push('\n             >  ',  type.escape('name') ,'<br>\n     ');  }) ; __p.push('\n  </form>\n  <form class="filter-list-price">\n    <span class="form-header">Price</span>\n    <input class="checkbox-price" type="radio" name="price" value="0"\n      ');  if (price[0] === "0") { ; __p.push('\n        ',  "checked" ,'\n      ');  } ; __p.push('\n      > < $0.00<br>\n    <input class="checkbox-price" type="radio" name="price" value="10"\n      ');  if (price[0] === "10") { ; __p.push('\n        ',  "checked" ,'\n      ');  } ; __p.push('\n      > < $10.00<br>\n    <input class="checkbox-price" type="radio" name="price" value="150"\n      ');  if (price[0] === "150") { ; __p.push('\n        ',  "checked" ,'\n      ');  } ; __p.push('\n      > < $150.00<br>\n    <input class="checkbox-price" type="radio" name="price" value="250"\n      ');  if (price[0] === "250") { ; __p.push('\n        ',  "checked" ,'\n      ');  } ; __p.push('\n      > < $250.00<br>\n    <input class="checkbox-price" type="radio" name="price"\n      ');  if (price[0] === "on") { ; __p.push('\n        ',  "checked" ,'\n      ');  } ; __p.push('\n      > All prices<br>\n  </form>\n</div>\n\n<div class="results-page">\n  <nav>\n    ');  if (results.total_count > 0) { ; __p.push('\n      Displaying page ',  results.pageNum ,' out of ',  Math.ceil(results.total_count / 15) ,' page(s)\n    ');  } else { ; __p.push('\n\t\t\tNo results, please search again\n\t\t');  } ; __p.push('\n  </nav>\n  <section class="results">\n    <ul class="search-results-full all-poke-list"></ul>\n    <span>\n      <nav class="group">\n\t\t\t\t');  if (results.pageNum > 1) { ; __p.push('\n\t\t\t\t\t<a class="prev-page" href="javascript:void(0)">\n\t\t\t\t\t\t<span class="prev-arrow"></span>\n\t\t\t\t\t\tPrevious Page\n\t\t\t\t\t</a>\n\t\t\t\t');  } ; __p.push('\n\t\t\t\t');  if (results.pageNum < Math.ceil(results.total_count / 15)) { ; __p.push('\n\t\t\t\t\t<a class="next-page" href="javascript:void(0)">\n\t\t\t\t\t\t<span class="next-arrow"></span>\n\t\t\t\t\t\tNext Page\n\t\t\t\t\t</a>\n\t\t\t\t');  } ; __p.push('\n\t\t\t</nav>\n    </span>\n  </section>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["products/list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="individual-list group">\n  <div class="result-image">\n    <a href="#/product/',  result.id ,'">\n      <img src="',  result.escape('image_url') ,'">\n    </a>\n  </div>\n  <div class="result-all-content group">\n    <div class="result-header">\n      <a href="#/product/',  result.id ,'">\n        ',  result.escape('name') ,'\n      </a>\n    </div>\n    <div class="result-summary-left">\n      <span class="result-price money">$',  result.escape('price') ,'</span>\n      <span class="result-date">Date found: ',  result.escape('created_at') ,'</span>\n      ');  result.escape('poke_types').split(",").forEach(function(type) { ; __p.push('\n        <a class="',  type ,' type-indicator type-bar" href="#/products/',  type ,'">',  type ,'</a>\n      ');  }) ; __p.push('\n    </div>\n    <div class="result-summary-right group">\n      <span class="result-rating" id="result-rating"></span>\n      <span class="description-header-results">\n        Product Description\n      </span>\n      <span class="result-description-thing">\n        ',  result.escape('description') ,'\n      </span>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["products/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'add-cart-message hidden group\' id=\'add-cart-message\'>\n  <span class=\'checkmark\'>\n    <img class="checkmark-img" src="',  Celadon.checkmarkLogo ,'">Added to Cart\n  </span>\n  <span class=\'quick-details\'>\n    Cart subtotal: <p class="price-tag">$',  Celadon.currentUser.escape('current_subtotal') ,'</p>\n  </span>\n  <span class=\'add-cart-message-btn\'>\n    <a href="#">Continue Shopping</a>\n    <a href="#/user/',  Celadon.currentUser.id ,'/cart_items">View your Cart</a>\n  </span>\n</div>\n\n<div class=\'content-right\'>\n  <div class=\'purchase-tab\'>\n    <span class=\'purchase-tab-qty\'>Qty:\n      <select id=\'purchase-qty-selection\'>\n        <option>1</option>\n        <option>2</option>\n        <option>3</option>\n        <option>4</option>\n        <option>5</option>\n        <option>6</option>\n        <option>7</option>\n        <option>8</option>\n        <option>9</option>\n      </select>\n    </span><br>\n    <span class="purchase-tab-details">\n      <p>$',  product.escape('price') ,'</p> + Free Shipping + Free Pokéball\n    </span><br>\n    <button class="sign-in-btn" id=\'add-cart-button\'>Add to Cart</button>\n  </div>\n</div>\n\n<div class=\'main-content group\'>\n  <div class=\'poke-image\'>\n    <img src="',  product.escape('image_url') ,'">\n  </div>\n  <div class=\'poke-content\'>\n    <div class=\'poke-content-header\'>\n      <h3>',  product.escape('name') ,'</h3>\n    </div>\n    <div class=\'poke-subheader\'>\n      <p class=\'price-name\'>Price: </p>\n      <p class=\'price\'>$',  product.escape('price') ,'</p><br>\n      <p class=\'price-name\'>Date found: </p>\n      <p class=\'date-found\'>',  product.escape('created_at') ,'</p>\n    </div>\n    <div class=\'poke-content-content\'>\n      Attack: ',  product.escape('attack') ,'<br>\n      Defense: ',  product.escape('defense') ,'<br>\n      Moves: ',  product.escape('moves').split(",").join(", ") ,'<br>\n      Type:\n      ');  product.escape('poke_types').split(",").forEach(function(type) { ; __p.push('\n        <a class="',  type ,' type-indicator" href="#/products/',  type ,'">',  type ,'</a>\n      ');  }) ; __p.push('\n\n      <br><p class=\'in-stock\'>In Stock.</p>\n    </div>\n\n  </div>\n  <div class=\'poke-content-description\'>\n    <h3 class=\'description-header\'>Product Description</h3>\n    <p class=\'description-body\'>',  product.escape('description') ,'</p>\n  </div>\n  <div class=\'poke-content-reviews\'>\n    <div>\n      <h3>Customer Reviews</h3>\n      <div class="review-summary">\n        <div class="average-star-rating" id="average-star-rating"></div>\n        Number of reviews: ',  product.escape('number_of_reviews') ,'<br>\n        ',  product.escape('average_star_rating') ,' out of 5 stars\n      </div>\n      <div class="review-create" id="review-create">\n        Share your thoughts with other customers\n        <button class=\'review-create-btn\'>Write a customer review</button>\n      </div>\n    </div>\n    <div class=\'poke-content-review-list\' id="reviews">\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="modal-screen"></div>\n</div>\n<form class="modal-review-form">\n  <h3>Write your review</h3>\n  Star Rating:\n  <div class="star-rate-input" id="star-rate"></div>\n  <p>Title:</p>\n  <input\n    id="title-input"\n    type="text"\n    name="review[title]"><br>\n  <p>Body:</p>\n  <textarea name="review[body]"></textarea>\n  <button id="submit-btn">Submit</button>\n  <div>\n    <p class="cancel" id="cancel-btn">Cancel</p>\n  </div>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li>\n  <div class="review-header">\n    <p>\n      By ',  review.escape('fname') ,' ',  review.escape('lname') ,' on ',  review.escape('created_at') ,'\n    </p>\n    <p class=\'title\'>\n      <div class="user-star-rating" id="user-star-rating"></div>\n      <p class=\'bold-title\'>',  review.escape('title') ,'</p>\n    </p>\n  </div>\n  <div class="review-body">\n    <p>\n      ',  review.escape('body') ,'\n    </p>\n  </div>\n</li>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["search"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="advertisement5"></div>\n<div class="results-page">\n\t<nav>\n\t\t');  if (results.total_count > 0) { ; __p.push('\n\t\t\tDisplaying page ',  results.pageNum ,' out of ',  Math.ceil(results.total_count / 15) ,' page(s) for <p>"',  Celadon.searchResults.query ,'"</p>\n\t\t');  } else { ; __p.push('\n\t\t\tNo results, please search again\n\t\t');  } ; __p.push('\n\t</nav>\n\t<section class="results">\n\t\t<ul class="search-results-full"></ul>\n\t\t<span>\n\t\t\t<nav class="group">\n\t\t\t\t');  if (results.pageNum > 1) { ; __p.push('\n\t\t\t\t\t<a class="prev-page" href="javascript:void(0)">\n\t\t\t\t\t\t<span class="prev-arrow"></span>\n\t\t\t\t\t\tPrevious Page\n\t\t\t\t\t</a>\n\t\t\t\t');  } ; __p.push('\n\t\t\t\t');  if (results.pageNum < Math.ceil(results.total_count / 15)) { ; __p.push('\n\t\t\t\t\t<a class="next-page" href="javascript:void(0)">\n\t\t\t\t\t\t<span class="next-arrow"></span>\n\t\t\t\t\t\tNext Page\n\t\t\t\t\t</a>\n\t\t\t\t');  } ; __p.push('\n\t\t\t</nav>\n\t\t</span>\n\t</section>\n</div>\n<div class="advertisment6"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["searchResults/list_item(delete)"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="individual-list group">\n  <div class="result-image">\n    <a href="#/product/',  result.id ,'">\n      <img src="',  result.escape('image_url') ,'">\n    </a>\n  </div>\n  <div class="result-all-content group">\n    <div class="result-header">\n      <a href="#/product/',  result.id ,'">\n        ',  result.escape('name') ,'\n      </a>\n    </div>\n    <div class="result-summary-left">\n      <span class="result-price money">$',  result.escape('price') ,'</span>\n      <span class="result-date">Date found: ',  result.escape('created_at') ,'</span>\n      ');  result.escape('poke_types').split(",").forEach(function(type) { ; __p.push('\n        <span class="',  type ,' type-indicator type-bar">',  type ,'</span>\n      ');  }) ; __p.push('\n    </div>\n    <div class="result-summary-right group">\n      <span class="result-rating" id="result-rating"></span>\n      <span class="description-header-results">\n        Product Description\n      </span>\n      <span class="result-description-thing">\n        ',  result.escape('description') ,'\n      </span>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sign_in"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>Sign in</h2>\n\n<form>\n  <label><p>Email</p>\n    <input type="text" name="user[email]">\n  </label><br>\n\n  <label>\n    <p>Password</p>\n    <input type="password" name="user[password]">\n  </label><br>\n\n  <button class="sign-in-btn">Sign in</button>\n</form>\n<a class="facebook-btn" href="/auth/facebook">Log in with Facebook</a>\n\n<button id="guest-sign-in-btn" class="sign-in-btn guest-sign-in-btn">Guest sign in</button>\n<div>\n  <p class="small-header">New to Celadon?</p><div class="divider"></div>\n  <a class="sign-in-btn create-btn" href="#/users/new">Create an account</a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["temporary"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="search-bar">\n  <div class="search-bar-input">\n    <input\n      class="search-bar-input-bar"\n      id="search-bar"\n      type="text"\n      name="user-input">\n    <div class="search-bar-button">\n      <img\n        class="search-bar-img"\n        src="',  Celadon.magnifyingGlass ,'">\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/edit_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="edit-form user-information">\n  <img src="',  user.escape('image_url') ,'" id="preview-post-image" width="100">\n  <div class="user-content">\n    <div>Edit your account</div>\n    <form class="edit-form-inner">\n      <div class="edit-form-input-section">\n        <span class="edit-form-label">\n          First Name\n        </span>\n        <input\n          id="user-fname"\n          type="text"\n          name="user[fname]"\n          value="',  user.escape('fname') ,'">\n      </div>\n      <div class="edit-form-input-section">\n        <span class="edit-form-label">\n          Last Name\n        </span>\n        <input\n          id="user-lname"\n          type="text"\n          name="user[lname]"\n          value="',  user.escape('lname') ,'">\n      </div>\n      <span class="edit-form-image">\n        Image\n        <input\n          type="file"\n          name="user[image]"\n          id="input-post-image">\n      </span>\n      <br>\n      <button class="sign-in-btn">Submit</button>\n    </form>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/new_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>Create Account</h2>\n\n<form>\n  <label><p>Your first name</p>\n    <input type="text" name="user[fname]">\n  </label><br>\n\n  <label><p>Your last name</p>\n    <input type="text" name="user[lname]">\n  </label><br>\n\n  <label><p>Email</p>\n    <input name="user[email]" type="text"><br>\n  </label><br>\n\n  <label><p>Password</p>\n    <input\n      name="user[password]"\n      type="password"\n      placeholder="at least 6 characters">\n    </label><br>\n\n  <button class="sign-in-btn">Create your Celadon account</button>\n</form>\n\n<span class="link-to-sign">Already have an account? <a href="#/session/new">Sign in</a></span>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="user-information">\n  <img src="',  user.escape('image_url') ,'">\n  <div class="user-content">\n    <div>',  user.escape('fname') ,' ',  user.escape('lname') ,'\'s Celadon</div>\n    <p>',  user.escape('email') ,'</p>\n    <p>\n      <a href="#/user/',  user.id ,'/ordered_items">\n        View your ordered items\n      </a>\n    </p>\n    <p>\n      <a href="#/user/',  user.id ,'/cart_items">\n        View your cart\n      </a>\n    </p>\n    <p>\n      <a href="#/user/',  user.escape('id') ,'/edit">Edit account</a>\n    </p>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
Celadon.Models.CartItem = Backbone.Model.extend({
